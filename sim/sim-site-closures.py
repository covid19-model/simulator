...
if __name__ == '__main__':
    ...
    if args.smoke_test:
        ...
        end_date = '2021-02-15'
        random_repeats = 1
        closures = [('social', 'education', 'office')]
        full_scale = False
    ...
    for closure in closures:
        ...
        p_stay_home_dict = copy.copy(basis)
        for sitetype in closure:
            p_stay_home_dict[sitetype] = 1.0
        ...
        info_str = "".join([f'{info}_' for info in closure])
        simulation_info = options_to_str(closures=info_str[:-1])
