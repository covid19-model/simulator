...
# -------------- Area information ----------------------------
area = 'KL'      # Area name used to name generated files, if possible set this to 'x' if file name is 'x_config.py'
area_code = 'SK Kaiserslautern'   # Code for the area of interest in the country specific case database (used by data module)
...
calibration_start_dates = '2020-03-15'
...
mobility_settings = {'downscaled': f'lib/mobility/Kaiserslautern_settings_10.pk',
                     'full scale': f'lib/mobility/Kaiserslautern_settings_1.pk'}

# calibration states loaded for calibrated parameters
calibration_states = 'logs/calibration_kl0_state.pk'
