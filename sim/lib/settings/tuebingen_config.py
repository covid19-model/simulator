...
# -------------- Area information ----------------------------
area = 'TU'      # Area name used to name generated files, if possible set this to 'x' if file name is 'x_config.py'
...
mobility_settings = {'downscaled': f'lib/mobility/Tubingen_settings_10.pk',
                     'full scale': f'lib/mobility/Tubingen_settings_1.pk'}

# calibration states loaded for calibrated parameters
calibration_states = 'logs/calibration_tu0_state.pk'
