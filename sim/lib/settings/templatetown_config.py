...
""" Template for the example of Tuebingen, Germany."""


# -------------- Area information ----------------------------
area = 'templatetown'      # Area name used to name generated files, if possible set this to 'x' if file name is 'x_config.py'
# Template for Tübingen
area_code = 'LK Tübingen'   # Code for the area of interest in the country specific case database (used by data module)
...
calibration_start_dates = '2020-03-12'
...
mobility_settings = {'downscaled': f'lib/mobility/{area}_settings_10.pk',
                     'full scale': f'lib/mobility/{area}_settings_1.pk'}
