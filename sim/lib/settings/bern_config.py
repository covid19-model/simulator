...
# -------------- Area information ----------------------------
area = 'BE'      # Area name used to name generated files, if possible set this to 'x' if file name is 'x_config.py'
area_code = 'BE'   # Code for the area of interest in the country specific case database (used by data module)
...
calibration_start_dates = '2020-03-06'
...
mobility_settings = {'downscaled': f'lib/mobility/Bern_settings_10.pk',
                     'full scale': f'lib/mobility/Bern_settings_1.pk'}

# calibration states loaded for calibrated parameters
calibration_states = 'logs/calibration_be0_state.pk'
